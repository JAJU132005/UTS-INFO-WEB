  ...
  <div className="content-container">
    <div className="row featurette">
      ...
      <div className="col-md-5">
          <img src={"../images/bienestar-7.jpg"} class="card-img-tap" alt="Card image 1"/>    
      </div>
    </div>
    ...
    <div className="row featurette">
      ...
      <div className="col-md-5 order-md-1">
        <img src={"../images/deporte.jpg"} class="card-img-tap" alt="Card image 1"/>
      </div>
    </div>
    <hr className="featurette-divider" />
    <div className="row featurette">
      ...
      <div className="col-md-5">
          <img src={"../images/diversidad.jpg"} class="card-img-tap" alt="Card image 1"/>
      </div>
    </div>
    <hr className="featurette-divider" />
  </div>
